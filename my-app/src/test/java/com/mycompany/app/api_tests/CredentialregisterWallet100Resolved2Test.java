  ...
  class CredentialregisterWallet100Resolved2Test {

      @Test
      void testAll() {
          String apiHostServer = System.getenv().getOrDefault("CREDENTIAL_WALLET_URL_BASE", "https://dev.roost.ai/api/");
          Results results = Runner.path("src/test/java/com/mycompany/app/api_tests/CredentialregisterWallet100Resolved2")
